...
export default function Resume() {
    ...
    return (
        <section className="w-full h-[89vh] flex flex-col justify-center items-center py-[40vh] px-[4vw] space-y-4 bg-gray-950 text-white">
            <div>
                <label
                    htmlFor="file-upload"
                ...
                <input
                    ...
                    className="mt-2 p-2 border border-gray-800 rounded bg-[#121212] text-white"
                />
            </div>
            <div>
                <label
                ...
                <textarea
                    ...
                    className="mt-2 p-2 border border-gray-800 rounded w-64 h-64 bg-[#121212] text-white"
